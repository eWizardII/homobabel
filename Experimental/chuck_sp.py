...
##            output = str(soup)
##
##            fileObj = open("B:/Cache/Twitter/json_scrap/temp.json","w")
##            fileObj.write(output)
##            fileObj.close()
##
##            json_data = open("B:/Cache/Twitter/json_scrap/temp.json")
##
...
##                i = i + 1
##
##            with open('B:/Cache/Twitter/junk/' + str(record_id['id_str']) + '.json', mode='w') as f:
##                json.dump(twitter_data, f, indent=2, encoding='utf-8')
##
##            f_in = open('B:/Cache/Twitter/junk/' + str(record_id['id_str']) + '.json', 'rb')
##            f_out = gzip.open('B:/Cache/Twitter/junk/' + str(record_id['id_str']) + '.json.gz', 'wb')
##            f_out.writelines(f_in)
##            f_out.close()
##            f_in.close()
##            os.remove('B:/Cache/Twitter/junk/' + str(record_id['id_str']) + '.json')
##            ou = ou + 1
##            tu = tu + 1
        except:
            i = i + 1
